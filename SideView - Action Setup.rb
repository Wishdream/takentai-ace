...
module N03
 #--------------------------------------------------------------------------
 # ● Sideview Battle System Configuration
 #--------------------------------------------------------------------------
  ...
  TURN_END_WAIT = 12
  # Invert the battle field (left to right) on surprise attack
  BACK_ATTACK = true
...
#==============================================================================
 ...
 #--------------------------------------------------------------------------
  ...
  "Vert Swing"    => ["wp", 0,[  6, 0],[ -4,-10], -45,  45,  4, false, [1,1], false, false,   -1,   "",    ""],
  "Shield"        => ["wp", 0,[  0, 0],[ 12,  0],   0,   0,  4, false, [1,1],  true,  true,   -1,   "",    ""],
 ...
 #--------------------------------------------------------------------------
  ...
  "Afterimage ON"   => ["mirage",  4,   3,  true,  160],
 ...
 #-------------------------------------------------------------------------- 
  ...
  "Rotate Right Once"  	=> ["angle",  12,    0, -360,   0],
  "Rotate Left Once"    => ["angle",  12,    0,  360,   0],
 ...
 #--------------------------------------------------------------------------
  ...
  "Derive Multi-Stage Attack"   => ["der",  true,  false,   130],
 ...
 #--------------------------------------------------------------------------
  ...
  # -Action Name-          Type   Branch  Script
...
#==============================================================================
  ...
  "Standby"          	=> ["Wait","60"],
  #Original Term - "Wait and See"          => ["Wait","60"],
  "Dead"              => ["Fallen"],
  ...
  "Victory Backward Somersault"  => ["Erase Battle Anim","Rotate Right Once","Victory Jump","Fist Limit","Thrust Fist Weapon","Fist Exclude","Wpn Swing R","120"],
  ...
  # -Shortcut/Parts Base (Called by other Full Actions)-
  ...
  "Space Background Release" => ["Reset Camera","Dim Background","target2('Clear Transparent WT')","Force Action 2","Clear Transparent","Clear Transparent","40","Remove Space Background","Hue Default"],
  ...
  "Bow Attack"          => ["One Step Before Move","Don't Collapse","Solo Start","Bow1","Bow Shot",
                        "Arrow Fire WT" ,"Solo End","Collapse","Coordinate Reset"],
  ...
  "Water Gun"           => ["Skill Motion","Wpn Swing R","se('pokemontrainer084')","Water Gun Fire","Coordinate Reset"],
  "Throw Weapon"        => ["Skill Motion","Bow1","Wpn Swing R","6","Wait(Fixed)","Wpn Throw Start" ,"Wpn Throw Return" ,"Coordinate Reset"],
  ...
  "Wolf Transformation" => ["Skill Motion","anime(110,false)","se('Wolf')","Wolf Transform","Wait(Fixed)","120","Coordinate Reset"],
  "Attack 5 Times"      => ["Skill Motion","Don't Collapse","Bow Exclude","Move Before Enemy","Attack","Attack","Attack","Attack","Attack","Collapse","Coordinate Reset"],
  "Derived Skill"       => ["Throw Weapon","Derive Multi-Stage Attack","Slash Attack"],
  "Background Change Attack" => ["Magic Motion","Wpn Swing R","se('ness004')","Space Background","Damage Animation","Space Background Release","Coordinate Reset"],
  ...
  "Air Attack"        	=> ["Skill Motion","Bow1","se('ike004')","One Step Before Jump","Before Jump Slam" ,
							"Wait(Fixed)","Rotate Left Once","10","se('ike003')","anime(117,false)","Slammed",
